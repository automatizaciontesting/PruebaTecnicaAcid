# encoding: iso-8859-1
Feature: Realizar login aplicacion conduit
  Como usuario quiero loguearme exitosamente y validar excepciones en el logueo
  ...
  Scenario: Validar excepciones sin credenciales de logue Conduit
    Given como "usuario" deseo loguearme
  ...
  @usuarioNoExistente
  Scenario: Validar datos invalidos de un usuario en Conduit
    Given como "usuario" deseo loguearme
